...
const goLoginAction = NavigationActions.navigate({
  routeName: 'Login',
  params: {},
...
export default class LoginScreen3 extends Component {
  ...
  goLogin = () => {
    this.props.navigation.dispatch(goLoginAction)
  }
  ...
  render() {
    ...
    return !fontLoaded ? (
      ...
      >
        ...
        >
          <Text style={styles.signUpText}>注 册</Text>
          <Text style={styles.whoAreYouText}>你 的 性 别 ?</Text>
