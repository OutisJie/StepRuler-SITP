...
import { Button, Avatar, Icon, Image } from 'react-native-elements'
...
export default class PyqItem extends React.Component {
		...
		return (
			<View style={{
				...
				{item.images.map((uri, i, arr) => {
					...
					// />
					return <Image source={{uri: this.props.isViewable ? uri : undefined}}/>
				})}
			</View>
		)
	}
